...
spawn(function() 
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>Youtube : @dtqmodder_09 <Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Modder Hub", HidePremium = false, IntroText = "ModderHub Library", SaveConfig = true, ConfigFolder = "Night Hub"})
...
M:AddParagraph("Kaitun","Dễ kick")

M:AddToggle({
    Name = "Kaitun[Không kill người chơi]",
    Default = false,
    Flag = "Kaitun",
    Save = true,
    Callback = function(Value)
