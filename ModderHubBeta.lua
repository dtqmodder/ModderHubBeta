...
function Update:Window(text,logo,keybind)
	...
	Logo.Image = "rbxassetid://"88779103850496"
	...
	function uitab:Tab(text)
		...
		function main:Dropdown(text,option,callback)
			...
			DropImage.Image = "rbxassetid://88779103850496"
...
local Library = Update:Window("Modder Hub ","",Enum.KeyCode.RightControl);
